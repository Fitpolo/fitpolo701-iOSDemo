...
/**
 升级成功回调
 */
typedef void(^fitpolo701UpdateProcessSuccessBlock)(void);
...
/**
 ...
 @param error 错误原因
 */
typedef void(^fitpolo701UpdateProcessFailedBlock)(NSError *error);
 ...
 */
typedef void(^fitpolo701UpdateProgressBlock)(CGFloat progress);

@interface fitpolo701UpgradeManager : NSObject
